    ...
    <div class="row">
        <div class="col-md-4 col-xl-3">
            <div class="card bg-c-pink order-card">
                <div class="card-block">
                    <h6 class="m-b-20">Projet Total</h6>
                    <h2 class="text-right"><i class="fa fa-align-justify f-left"></i><span>{{ $projects->count() }}</span></h2>
                </div>
            </div>
        </div>
        <div class="col-md-4 col-xl-3">
            <div class="card bg-c-blue order-card">
                <div class="card-block">
                    <h6 class="m-b-20">Projet en cours</h6>
        ...
        <div class="col-md-4 col-xl-3">
            <div class="card bg-c-yellow order-card">
                <div class="card-block">
                    <h6 class="m-b-20">Projet en attente</h6>
        ...
        <div class="col-md-4 col-xl-3">
            <div class="card bg-c-green order-card">
                <div class="card-block">
                    <h6 class="m-b-20">Projet terminé</h6>
    ...
    <div class="col-md-12 animated fadeInUp">
        <div class="card card-plain">
            <div class="card-header card-header-primary">
                <h4 class="card-title mt-0"> Liste projet </h4>
            </div>
            <div class="card-body">
                <div class="table-responsive">
                    <table class="table table-hover table-striped display" id="table_project" style="text-align:center;"><font></font>
                        <thead class="table-info"><font></font>
                            ...
                            <th style="font-weight:bold; color:purple;">Client</th><font></font>
            ...
            [
                @foreach ($projects as $project)
                    [
                        ...
                        "{!!
                             "<a href='". route('project.show', $project->id) ."' class='btn btn-sm btn-success' data-placement='top' data-toggle='tooltip' title='Détails'><i class='fas fa-eye'></i></a>".
                             "<a href='".route('project.edit', $project->id) ."' class='btn btn-sm btn-info' data-placement='top' data-toggle='tooltip' title='Editer'><i class='fas fa-pen'></i></a>"
                        !!}",
                    ],
                @endforeach
                ...
                buttons: [
                    {
                        ...
                        action: function ( e, dt, node, config ) {
                            document.location.href="{{ route('project.create') }}";
                        }
                    }
                ]
            } );
