...
<div class="row animated fadeInUp">
        <div class="col-md-10 offset-md-1">
            <h1 class="text-info text-uppercase font-weight-bold"> Créer un projet </h1>
            <div class="jumbotron" style="background:white;">

                <form class="needs-validation" action="{{ route('project.store') }}" method="POST">
                    {{ csrf_field() }}
                    <div class="mb-3">
                    ...
                    <div class="row">
                        <div class="col-md-6 mb-3">
                            ...
                            <select class="custom-select d-block w-100 @error('type') is-invalid @enderror" id="type" name="type" required>
                                ...
                                <option value="TP">Traveaux pratique</option>
                ...
                <div class="row">
                    <div class="col-md-4 mb-3">
                        ...
                        <input type="number" name="step" id="step" class="form-control @error('step') is-invalid @enderror" value="{{ old('step') }}" required>
                        @error('step')
                            <span class="invalid-feedback" role="alert">
                                <strong>{{ $message }}</strong>
                            </span>
                ...
                <div class="row">
                    <div class="col-md-6 mb-3">
                        ...
                        <input type="date" name="date_start" id="date_start" class="form-control @error('date_start') is-invalid @enderror" value="{{ old('date_start') }}" placeholder="jj/mm/aaaa" required>
                        @error('date_start')
                            <span class="invalid-feedback" role="alert">
                                <strong>{{ $message }}</strong>
                            </span>
                    ...
                    <div class="col-md-6 mb-3">
                        ...
                        <input type="date" name="date_end" id="date_end" class="form-control @error('date_end') is-invalid @enderror" value="{{ old('date_end') }}" placeholder="jj/mm/aaaa" required>
                        @error('date_end')
                            <span class="invalid-feedback" role="alert">
                                <strong>{{ $message }}</strong>
                            </span>
                ...
                <div class="row">
                    <div class="col-md-6 mb-3">
                        ...
                        <input type="date" name="deadline" id="deadline" class="form-control @error('deadline') is-invalid @enderror" value="{{ old('deadline') }}" placeholder="jj/mm/aaaa" required>
                        @error('deadline')
                            <span class="invalid-feedback" role="alert">
                                <strong>{{ $message }}</strong>
                            </span>
                    ...
                    <div class="col-md-8 mb-3">
                        ...
                        <input type="text" name="version" id="version" class="form-control @error('version') is-invalid @enderror" value="{{ old('version')?: 'V1.0.0' }}" required>
                        @error('version')
                            <span class="invalid-feedback" role="alert">
                                <strong>{{ $message }}</strong>
                            </span>
                ...
                <button class="btn btn-primary btn-lg btn-block" type="submit">Créer un projet</button>
            </form>
